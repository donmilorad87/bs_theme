 ...
 * @return bool
 */
function ct_sidebar_has_content_block( $position ) {
 ...
 */
function ct_sidebar_resolve_post_id() {
 ...
 */
function ct_sidebar_get_mode( $position ) {
 ...
 * @return bool
 */
function ct_sidebar_has( $position ) {
 ...
 */
function ct_sidebar_extract_content( $position ) {
 ...
 * @return void
 */
function ct_sidebar_render( $position ) {
 ...
 */
function ct_sidebar_layout_classes() {
