...
(function () {
	...
	/**
	 * Regex matching ct_translate('KEY', [.../{...}], 'form'|N) patterns.
	...
	/**
	 * Replace all ct_translate() patterns in a text string.
	 *
	...
	function resolve(text) {
		...
		if (text.indexOf('ct_translate(') === -1) {
			return text;
		}
	...
	/**
	 * Find all ct_translate() patterns in a text string.
	 *
	 * @param {string} text Input text.
