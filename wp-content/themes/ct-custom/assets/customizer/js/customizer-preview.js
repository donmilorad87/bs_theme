...
(function () {
    ...
    CustomizerPreview.prototype._buildCssSettingsList = function () {
        ...
        return [
            ...
            'bs_header_logo_width', 'bs_header_logo_margin_left', 'bs_header_logo_margin_right',
    ...
    CustomizerPreview.prototype._buildHeaderCSS = function (v) {
        ...
        css += '.site-header__logo img { width:' + v.bs_header_logo_width + 'px; height:auto; }';
    ...
    CustomizerPreview.prototype._buildTypographyCSS = function (v) {
        ...
        var headings = [
            ['h1, .entry-title, .page-title', 'bs_h1'],
            ['h2', 'bs_h2'],
            ['h3, .section-title', 'bs_h3'],
            ['h4', 'bs_h4'],
            ['h5', 'bs_h5'],
        ];
