 ...
 */
if ( ! function_exists( 'bs_team_hex_to_rgba' ) ) :
function bs_team_hex_to_rgba( $hex, $opacity ) {
...
/* Resolve bs_translate() patterns if Translation Service is available */
...
$custom_props .= '--ct-showmore-bg-light:' . esc_attr( bs_team_hex_to_rgba( $showmore_bg_color, $showmore_opacity ) ) . ';';
...
$custom_props .= '--ct-showmore-bg-dark:' . esc_attr( bs_team_hex_to_rgba( $showmore_bg_color_dk, $showmore_opacity ) ) . ';';
