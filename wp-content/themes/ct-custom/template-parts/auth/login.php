...
?>
<div class="ct-auth-form ct-auth-form--login" role="form" aria-label="<?php esc_attr_e( 'Login form', 'ct-custom' ); ?>">
    <div class="ct-auth-form__header df jcsb aic">
        <h3 class="ct-auth-form__title m0"><?php esc_html_e( 'Log In', 'ct-custom' ); ?></h3>
    </div>
    ...
    <div class="ct-auth-form__fields">
        <div class="ct-auth-form__field">
            <label for="ct-login-user" class="ct-auth-form__label fs14"><?php esc_html_e( 'Username or Email', 'ct-custom' ); ?></label>
            <input type="text" id="ct-login-user" class="ct-auth-form__input fs14" name="username_or_email"
                   autocomplete="username" required
                   data-ct-validate-required="true"
                   data-ct-validate-min="1">
        </div>
        <div class="ct-auth-form__field">
            <label for="ct-login-pass" class="ct-auth-form__label fs14"><?php esc_html_e( 'Password', 'ct-custom' ); ?></label>
            <div class="ct-auth-form__password-wrap">
                <input type="password" id="ct-login-pass" class="ct-auth-form__input fs14" name="password"
    ...
    <button type="button" class="ct-auth-form__submit df aic jcc w100 cp ct-auth-form__submit--disabled" data-ct-auth-action="login" disabled>
        <span class="ct-auth-form__submit-text"><?php esc_html_e( 'Log In', 'ct-custom' ); ?></span>
    </button>
